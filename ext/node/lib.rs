...
deno_core::extension!(deno_node,
  ...
  ops = [
    ...
    ops::os::op_cpus<P>,
    ops::os::op_homedir<P>,
    ops::sqlite::op_sqlite_open,
    ops::sqlite::op_sqlite_prepare,
    ops::sqlite::op_sqlite_expandedsql,
    ops::sqlite::op_sqlite_exec,
    ops::sqlite::op_sqlite_get,
    ops::sqlite::op_sqlite_exec_noargs,
    op_node_build_os,
